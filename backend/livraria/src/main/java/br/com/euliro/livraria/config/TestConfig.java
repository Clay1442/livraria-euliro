...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order order1 = new Order(null, user1, Instant.parse("2025-07-10T19:53:07Z"), OrderStatus.PAGAMENTO_APROVADO);
        Order order2 = new Order(null, user2, Instant.parse("2025-07-11T03:42:10Z"), OrderStatus.ENVIADO);
